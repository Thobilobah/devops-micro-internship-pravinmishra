...
![Space confirmation or Space sidebar showing the Space name and key](/week-05-devops-lifecycle/screenshots/Ass-02-Screenshot-01.png)
...
![Backlog showing the Epic panel enabled and the Epic visible](/week-05-devops-lifecycle/screenshots/Ass-02-Screenshot-02.png)
...
![One opened Story showing its Story point estimate, acceptance criteria, and label](/week-05-devops-lifecycle/screenshots/Ass-02-Screenshot-03.png)
...
![S2 showing all four Sub-tasks](/week-05-devops-lifecycle/screenshots/Ass-02-Screenshot-04.png)

---

#### Screenshot 6 — S4 showing all four Sub-tasks

![S4 showing all four Sub-tasks](/week-05-devops-lifecycle/screenshots/Ass-02-Screenshot-05.png)
...
![Backlog or Story details showing labels applied to at least two visible Stories](/week-05-devops-lifecycle/screenshots/Ass-02-Screenshot-06a.png)
![Backlog or Story details showing labels applied to at least two visible Stories](/week-05-devops-lifecycle/screenshots/Ass-02-Screenshot-06b.png)
---
...
![Sprint 1 before starting, showing the selected Stories and Story Points](/week-05-devops-lifecycle/screenshots/Ass-02-Screenshot-07.png)

---

#### Screenshot 9 — Active Sprint board showing the started Sprint and Sprint Goal

![Active Sprint board showing the started Sprint and Sprint Goal](/week-05-devops-lifecycle/screenshots/Ass-02-Screenshot-08.png)
...
![Filter for label = frontend showing the filtered results](/week-05-devops-lifecycle/screenshots/Ass-02-Screenshot-09.png)

---

#### Screenshot 11 — Filter for label = devops showing the filtered results

![Filter for label = devops showing the filtered results](/week-05-devops-lifecycle/screenshots/Ass-02-Screenshot-10.png)
...
![Burndown Chart page opened for Sprint 1](/week-05-devops-lifecycle/screenshots/Ass-02-Screenshot-11.png)
