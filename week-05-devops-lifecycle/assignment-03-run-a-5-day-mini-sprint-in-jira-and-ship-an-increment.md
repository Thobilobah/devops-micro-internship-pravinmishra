...
![Sprint 1 created with the Story inside it](/week-05-devops-lifecycle/screenshots/Ass-03-Screenshot-01.png)

---

#### Screenshot 2 — Active Sprint board showing the Sprint Goal

![Active Sprint board showing the Sprint Goal](/week-05-devops-lifecycle/screenshots/Ass-03-Screenshot-02a.png)
![Active Sprint board showing the Sprint Goal](/week-05-devops-lifecycle/screenshots/Ass-03-Screenshot-02a.png)
...
![Jira board showing the Day 1 Sub-task in Done](/week-05-devops-lifecycle/screenshots/Ass-03-Screenshot-03.png)

---

#### Screenshot 4 — Successful Git commit output

![Successful Git commit output](/week-05-devops-lifecycle/screenshots/Ass-03-Screenshot-04.png)

---

#### Screenshot 5 — EC2 browser view showing the complete footer text, with the URL visible

![EC2 browser view showing the complete footer text, with the URL visible](/week-05-devops-lifecycle/screenshots/Ass-03-Screenshot-05.png)

---

#### Screenshot 6 — Jira Story comment showing the Day 1 Daily Scrum update

![Jira Story comment showing the Day 1 Daily Scrum update](/week-05-devops-lifecycle/screenshots/Ass-03-Screenshot-06.png)
...
![Code editor showing the footer and date logic or deployment-time template snippet](/week-05-devops-lifecycle/screenshots/Ass-03-Screenshot-06b.png)

---

#### Screenshot 8 — EC2 browser view showing the updated footer with the current date

![EC2 browser view showing the updated footer with the current date](/week-05-devops-lifecycle/screenshots/Ass-03-Screenshot-07.png)

---

#### Screenshot 9 — README snippet documenting the footer and date behavior

![README snippet documenting the footer and date behavior](/week-05-devops-lifecycle/screenshots/Ass-03-Screenshot-08.png)

---

#### Screenshot 10 — Jira Story comment showing the Day 2 Daily Scrum update

![Jira Story comment showing the Day 2 Daily Scrum update](/week-05-devops-lifecycle/screenshots/Ass-03-Screenshot-09.png)
...
![Desktop EC2 view showing the polished footer](/week-05-devops-lifecycle/screenshots/Ass-03-Screenshot-11.png)

---

#### Screenshot 12 — Mobile responsive view showing the footer remains readable

![Mobile responsive view showing the footer remains readable](/week-05-devops-lifecycle/screenshots/Ass-03-Screenshot-12.png)

---

#### Screenshot 13 — Jira Story comment showing the Day 3 Daily Scrum update

![Jira Story comment showing the Day 3 Daily Scrum update](/week-05-devops-lifecycle/screenshots/Ass-03-Screenshot-13.png)
...
![EC2 browser view showing "Start your DevOps Journey here" and the clickable "Visit the DMI Website" link](/week-05-devops-lifecycle/screenshots/Ass-03-Screenshot-14a.png)
...
![Burndown Chart for Sprint 1](/week-05-devops-lifecycle/screenshots/Ass-03-Screenshot-15.png)

---

#### Screenshot 16 — Jira retrospective comment

![Jira retrospective comment](/week-05-devops-lifecycle/screenshots/Ass-03-Screenshot-16.png)

---

#### Screenshot 17 — Final EC2 browser view showing the complete footer requirement

![Final EC2 browser view showing the complete footer requirement](/week-05-devops-lifecycle/screenshots/Ass-03-Screenshot-17.png)
...
https://www.loom.com/share/94242bb54f3347b4a8c3cec30c47e78d
...
https://www.linkedin.com/posts/oluwatobiloba-taiwo_completed-my-five-day-mini-sprint-over-ugcPost-7491133385084534784-Y3Li/?utm_source=share&utm_medium=member_desktop&rcm=ACoAACz7IugBIR_XEr4WBbn9LYa6OeAS8fYZbYA

---

#### LinkedIn Screenshot 1 — Published LinkedIn post showing the post content and at least one required link or proof image

![Published LinkedIn post showing the post content and at least one required link or proof image](/week-05-devops-lifecycle/screenshots/Ass-03-Screenshot-18.png)
