...
![Output of `git status` and `git branch` showing a clean status and the default branch checked out](/week-04-git-and-github/screenshots/Ass-03-Screenshot-01.png)
...
![Output of `git checkout -b feature/contact-page` and `git branch` showing `* feature/contact-page`](/week-04-git-and-github/screenshots/Ass-03-Screenshot-02.png)
...
![Output of `ls` showing `contact.html`](/week-04-git-and-github/screenshots/Ass-03-Screenshot-03.png)

---

#### Screenshot 4 — Output of `git commit`

![Output of `git commit`](/week-04-git-and-github/screenshots/Ass-03-Screenshot-04.png)

---

#### Screenshot 5 — Output of `git log --oneline -3` showing the new commit

![Output of `git log --oneline -3` showing the new commit](/week-04-git-and-github/screenshots/Ass-03-Screenshot-05.png)
...
![Output of `git status` showing `index.html` as modified before staging](/week-04-git-and-github/screenshots/Ass-03-Screenshot-06.png)

---

#### Screenshot 7 — Output of `git commit`

![Output of `git commit`](/week-04-git-and-github/screenshots/Ass-03-Screenshot-07.png)

---

#### Screenshot 8 — Browser showing the Contact Page link on the homepage while on `feature/contact-page`

![Browser showing the Contact Page link on the homepage while on `feature/contact-page`](/week-04-git-and-github/screenshots/Ass-03-Screenshot-08.png)
...
![Terminal showing the checkout and `ls` output, proving `contact.html` is absent](/week-04-git-and-github/screenshots/Ass-03-Screenshot-09.png)

---

#### Screenshot 10 — Browser showing the homepage on the default branch with no Contact Page link

![Browser showing the homepage on the default branch with no Contact Page link](/week-04-git-and-github/screenshots/Ass-03-Screenshot-10.png)
...
![Output of `git merge feature/contact-page`](/week-04-git-and-github/screenshots/Ass-03-Screenshot-11.png)

---

#### Screenshot 12 — Output of `ls` showing `contact.html` after the merge

![Output of `ls` showing `contact.html` after the merge](/week-04-git-and-github/screenshots/Ass-03-Screenshot-12.png)

---

#### Screenshot 13 — Browser showing the Contact page opened from the homepage link on the default branch

![Browser showing the Contact page opened from the homepage link on the default branch](/week-04-git-and-github/screenshots/Ass-03-Screenshot-13.png)
...
![Full output of `git log --oneline --graph --decorate --all`](/week-04-git-and-github/screenshots/Ass-03-Screenshot-14.png)
...
![Output showing `feature/contact-page` deleted and no longer listed](/week-04-git-and-github/screenshots/Ass-03-Screenshot-15.png)
